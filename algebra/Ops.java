...
public class Ops {
	...
	public static Vec refract(Vec u, Vec normal, double n1, double n2) {
		...
		b = normalize(b);
		double sinTheta2sq = (n1 * n1 * (1 - dp)) / (n2 * n2);
		double cosTheta2sq = 1 - sinTheta2sq;
		double sinTheta2 = Math.sqrt(sinTheta2sq);
		double cosTheta2 = Math.sqrt(cosTheta2sq);
